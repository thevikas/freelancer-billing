...
<div class="header-bottom row">
	...
	<div class="large-6 medium-6 columns invoice-header">
		...
		<table>
			<thead>
				<tr>
					<td><div class="circle"><img class="icon-dollar" src="/images/dollar.png"></div></td>
					<td><div class="circle"><img class="icon-calendar" src="/images/calendar.png"></div></td>
					<td><div class="circle" style="padding-top:20px;"><img class="icon-barcode" src="/images/barcode.png"></div></td>
				</tr>
			</thead>
			<tbody>
				<tr>
